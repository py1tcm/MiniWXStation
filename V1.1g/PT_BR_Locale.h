#ifndef PT_BR_LOCALE_H
#define PT_BR_LOCALE_H
//****************************************************
//* MINIWX STATION  - MAIN INFO PAGE
//* PORTUGUESE (BRAZIL) LANGUAGE
//****************************************************
const char PAGE_Main_PT_BR[] PROGMEM = "<!DOCTYPE html>\
<html>\
<head>\
...
function getData() {\
  ...
  <body>\
    <hr>\
    <h3 style='text-shadow: 2px 1px grey;'>{{callsign}} Estação Meteorológica - <a id='clock' class='tabheader' style='padding-right:10px'>{{time}}</a></h3>\
    <h4>\
      ...
      <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn' style='width:{{fieldsize5}}'>\
              ...
              <div class='tabheader'>IP atual</div>\
    ...
    <form action='/submit' method='POST'>\
      ...
      <legend style='text-shadow: 2px 1px grey;'> Painel de controle </legend>\
...
//* PORTUGUESE (BRAZIL) LANGUAGE
//***********************************************************
const char PAGE_MiniWXSettings_PT_BR[] PROGMEM = "<!DOCTYPE html>\
<html>\
<head>\
<meta lang='pt-BR' http-equiv='Content-Type' content='text/html; charset=UTF-8'>\
<title>MiniWX Configurações</title>\
</head>\
<style>\
    ...
    <form style='width:58%' action='/submit' method='POST'>\
        ...
        <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>Configurações APRS</h2></legend>\
            ...
            <div class='divColumn'>\
              ...
              <legend><h2>Configuração de IP estático</h2></legend>\
                <span>\
                  ...
                  <label>Usar IP estático (requer reinicialização)</label>\
                </span><p></p>\
                <label>IP</label>\
          ...
          <div class='divRow'>\
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>Configurações WUNDER</h2></legend>\
                <div>\
                  <span>\
