/***************************************************************
  ...
  = v1.1g =  
  - Added German language translation and integration(20241020 DL9SEC)
  - Changed uptime string to a more language neutral format (20241020 DL9SEC)
  - Corrected "Exit"-button in Wifi scan (20241020 DL9SEC) -> ToDo: Complete localization of the Wifi scan page
  - Commented out unnecessary "<form>/</form>" at Wifi scan (already included in "HTTP_EXIT_BUTN" (20241020 DL9SEC)
  - Corrected compiler warnings because of whitespaces after "\" (20241020 DL9SEC)
...
#endif
#ifdef LANG_GERMAN
  String page = FPSTR(PAGE_Main_DE);
#endif
...
void handleSubmit() {
  ...
  if (server.args() > 0 ) {
...
#endif
#ifdef LANG_GERMAN
      message += F("<form><div class='divTable'><div class='divRow'><div class='divColumn' style='width:98%'><div class='notabheader'>Sende Pakete zum APRS-Server...</div>");
#endif
...
#endif
#ifdef LANG_GERMAN
      message += F("<form><div class='divTable'><div class='divRow'><div class='divColumn' style='width:98%'><div class='notabheader'>Sende Pakete zum WUNDER-Server...</div>");
#endif
      message += F("</div></div></div></form></fieldset>");
      message += FPSTR(HTTP_FOOT);
...
#endif
#ifdef LANG_GERMAN
      message += F("<form><div class='divTable'><div class='divRow'><div class='divColumn' style='width:98%'><div class='notabheader'>Sende NTP SYNC-Anfrage zum Server...</div>");
#endif
    ...
    #endif
    #ifdef LANG_GERMAN
      message.replace(F("{{exit_btn}}"), "Verlassen");
    #endif
...
#endif
#ifdef LANG_GERMAN
  String page = FPSTR(PAGE_MiniWXSettings_DE);
#endif
...
#endif
#ifdef LANG_GERMAN
  message.replace(F("{{svg_temp}}"), "Temperatur (°C)");
  message.replace(F("{{svg_pres}}"), "Luftdruck (hPa)");
  message.replace(F("{{svg_rhum}}"), "Relative Luftfeuchtigkeit (%)");
  message.replace(F("{{svg_rssi}}"), "RSSI (dBm)");
#endif
